...
//    Endian       =  little
//    Source file  =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_ADC.c
//    Command line =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_ADC.c
...
//    List file    =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\project\ligen_car通用7-23-20.36\iar\FLASH\List\HW_ADC.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   68   //配置ADC时钟
//   69   if(adcx == ADC0)
        LDR.W    R0,??DataTable10_2  ;; 0x4003b000
        CMP      R4,R0
...
//   72     SIM->SCGC6 |= SIM_SCGC6_ADC0_MASK;   // 开启ADC0时钟
        LDR.W    R0,??DataTable10_3  ;; 0x4004803c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x8000000
        LDR.W    R1,??DataTable10_3  ;; 0x4004803c
        STR      R0,[R1, #+0]
//   73   }
...
??LPLD_ADC_Init_0:
        ...
        B.N      ??LPLD_ADC_Init_1
??LPLD_ADC_Init_6:
        LDR.W    R0,??DataTable10_7  ;; 0x4003c000
        CMP      R4,R0
        ...
        B.N      ??LPLD_ADC_Init_1
??LPLD_ADC_Init_7:
        LDR.W    R0,??DataTable10_8  ;; 0x400bc000
        CMP      R4,R0
...
//  163   //配置ADC时钟
//  164   if(adcx == ADC0)
        LDR.W    R1,??DataTable10_2  ;; 0x4003b000
        CMP      R0,R1
...
??LPLD_ADC_Deinit_2:
        ...
        BX       LR               ;; return
??LPLD_ADC_Deinit_0:
        LDR.W    R1,??DataTable10_5  ;; 0x400bb000
        CMP      R0,R1
...
??LPLD_ADC_Deinit_3:
        LDR.W    R1,??DataTable10_7  ;; 0x4003c000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_Deinit_4
        LDR.W    R0,??DataTable10_6  ;; 0x40048030
        LDR      R0,[R0, #+0]
        ...
        B.N      ??LPLD_ADC_Deinit_1
??LPLD_ADC_Deinit_4:
        LDR.W    R1,??DataTable10_8  ;; 0x400bc000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_Deinit_5
        LDR.W    R0,??DataTable10_6  ;; 0x40048030
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x10000000
        LDR.W    R1,??DataTable10_6  ;; 0x40048030
...
??LPLD_ADC_EnableIrq_3:
        LDR.W    R1,??DataTable10_7  ;; 0x4003c000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_EnableIrq_4
        MOVS     R0,#+2
        B.N      ??LPLD_ADC_EnableIrq_1
??LPLD_ADC_EnableIrq_4:
        LDR.W    R1,??DataTable10_8  ;; 0x400bc000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_EnableIrq_5
        MOVS     R0,#+3
        B.N      ??LPLD_ADC_EnableIrq_1
??LPLD_ADC_EnableIrq_5:
        MOVS     R0,#+0
...
??LPLD_ADC_DisableIrq_3:
        LDR.W    R1,??DataTable10_7  ;; 0x4003c000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_DisableIrq_4
        MOVS     R0,#+2
        B.N      ??LPLD_ADC_DisableIrq_1
??LPLD_ADC_DisableIrq_4:
        LDR.W    R1,??DataTable10_8  ;; 0x400bc000
        CMP      R0,R1
        BNE.N    ??LPLD_ADC_DisableIrq_5
        MOVS     R0,#+3
        B.N      ??LPLD_ADC_DisableIrq_1
??LPLD_ADC_DisableIrq_5:
        MOVS     R0,#+0
...
??LPLD_ADC_Chn_Enable_0:
        LDR.W    R3,??DataTable10_2  ;; 0x4003b000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_4:
        ...
        MOVS     R0,#+0
        LDR.W    R1,??DataTable10_9  ;; 0x4004b008
        STR      R0,[R1, #+0]
...
??LPLD_ADC_Chn_Enable_5:
        ...
        MOVS     R0,#+0
        LDR.W    R1,??DataTable10_10  ;; 0x4004c004
        STR      R0,[R1, #+0]
...
??LPLD_ADC_Chn_Enable_2:
        LDR.N    R3,??DataTable10_5  ;; 0x400bb000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_26:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_11  ;; 0x40049000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        STR      R0,[R2, R1, LSL #+2]
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_19:
        LDR.N    R3,??DataTable10_7  ;; 0x4003c000
        CMP      R0,R3
        BNE.N    ??LPLD_ADC_Chn_Enable_31
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        MOVS     R0,R1
        CMP      R0,#+0
        CMP      R0,#+3
        BLS.N    ??LPLD_ADC_Chn_Enable_32
        SUBS     R0,R0,#+4
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_33
        SUBS     R0,R0,#+2
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_34
        SUBS     R0,R0,#+2
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_35
        SUBS     R0,R0,#+2
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_36
        SUBS     R0,R0,#+2
        CMP      R0,#+3
        BLS.N    ??LPLD_ADC_Chn_Enable_37
        SUBS     R0,R0,#+4
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_38
        SUBS     R0,R0,#+2
        CMP      R0,#+2
        BLS.N    ??LPLD_ADC_Chn_Enable_39
        SUBS     R0,R0,#+5
        BEQ.N    ??LPLD_ADC_Chn_Enable_39
        SUBS     R0,R0,#+3
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_39
        SUBS     R0,R0,#+3
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_39
        B.N      ??LPLD_ADC_Chn_Enable_40
??LPLD_ADC_Chn_Enable_32:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_33:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+0
        BNE.N    ??LPLD_ADC_Chn_Enable_41
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LSLS     R1,R1,#+2
        ADD      R1,R1,#+1073741824
        ADDS     R1,R1,#+303104
        STR      R0,[R1, #+64]
??LPLD_ADC_Chn_Enable_41:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_34:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_35:
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LSLS     R1,R1,#+2
        ADD      R1,R1,#+1073741824
        ...
        STR      R0,[R1, #-32]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_36:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_37:
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        RSBS     R1,R1,#+0
        LSLS     R1,R1,#+2
...
??LPLD_ADC_Chn_Enable_38:
        ...
        STR      R0,[R1, #-32]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_39:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_40:
        MOVS     R0,#+0
        B.N      ??LPLD_ADC_Chn_Enable_1
??LPLD_ADC_Chn_Enable_31:
        LDR.N    R3,??DataTable10_8  ;; 0x400bc000
        CMP      R0,R3
        BNE.N    ??LPLD_ADC_Chn_Enable_42
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        MOVS     R0,R1
        CMP      R0,#+0
        CMP      R0,#+3
        BLS.N    ??LPLD_ADC_Chn_Enable_43
        SUBS     R0,R0,#+4
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_44
        SUBS     R0,R0,#+2
        BEQ.N    ??LPLD_ADC_Chn_Enable_45
        SUBS     R0,R0,#+1
        BEQ.N    ??LPLD_ADC_Chn_Enable_46
        SUBS     R0,R0,#+1
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_47
        SUBS     R0,R0,#+2
        CMP      R0,#+4
        BLS.N    ??LPLD_ADC_Chn_Enable_48
        SUBS     R0,R0,#+5
        BEQ.N    ??LPLD_ADC_Chn_Enable_49
        SUBS     R0,R0,#+1
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_50
        SUBS     R0,R0,#+2
        CMP      R0,#+2
        BLS.N    ??LPLD_ADC_Chn_Enable_51
        SUBS     R0,R0,#+5
        BEQ.N    ??LPLD_ADC_Chn_Enable_51
        SUBS     R0,R0,#+3
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_51
        SUBS     R0,R0,#+3
        CMP      R0,#+1
        BLS.N    ??LPLD_ADC_Chn_Enable_51
        B.N      ??LPLD_ADC_Chn_Enable_52
??LPLD_ADC_Chn_Enable_43:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_44:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+0
        BNE.N    ??LPLD_ADC_Chn_Enable_53
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        RSBS     R1,R1,#+0
        LSLS     R1,R1,#+2
        ...
        ADDS     R1,R1,#+299008
        STR      R0,[R1, #+56]
        B.N      ??LPLD_ADC_Chn_Enable_54
??LPLD_ADC_Chn_Enable_53:
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        RSBS     R1,R1,#+0
        LSLS     R1,R1,#+2
        ...
        ADDS     R1,R1,#+315392
        STR      R0,[R1, #+124]
??LPLD_ADC_Chn_Enable_54:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_45:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable10_12  ;; 0x40049018
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_46:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable10_13  ;; 0x4004d070
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_47:
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LSLS     R1,R1,#+2
        ADD      R1,R1,#+1073741824
        ...
        STR      R0,[R1, #-32]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_48:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_49:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable10_14  ;; 0x4004902c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_50:
        MOVS     R0,#+0
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LSLS     R1,R1,#+2
        ADD      R1,R1,#+1073741824
        ...
        STR      R0,[R1, #-20]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_51:
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_52:
        MOVS     R0,#+0
        B.N      ??LPLD_ADC_Chn_Enable_1
??LPLD_ADC_Chn_Enable_42:
        MOVS     R0,#+0
        B.N      ??LPLD_ADC_Chn_Enable_1
//  839 }
//  840 
