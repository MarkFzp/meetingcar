...
//    Endian       =  little
//    Source file  =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_ENET.c
//    Command line =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_ENET.c
...
//    List file    =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\project\ligen_car通用7-23-20.36\iar\FLASH\List\HW_ENET.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  533   ENET->PALR = (uint32)((pa[0]<<24) | (pa[1]<<16) | (pa[2]<<8) | pa[3]);
        ...
        LDRB     R2,[R0, #+3]
        ORRS     R1,R2,R1
        LDR.N    R2,??DataTable14_48  ;; 0x400c00e4
        STR      R1,[R2, #+0]
//  534   ENET->PAUR = (uint32)((pa[4]<<24) | (pa[5]<<16));
        ...
        LSLS     R2,R2,#+16
        ORRS     R1,R2,R1, LSL #+24
        LDR.N    R2,??DataTable14_49  ;; 0x400c00e8
        STR      R1,[R2, #+0]
//  535   
