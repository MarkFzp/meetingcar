...
//    Endian       =  little
//    Source file  =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_FTM.c
//    Command line =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_FTM.c
...
//    List file    =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\project\ligen_car通用7-23-20.36\iar\FLASH\List\HW_FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   60   if(ftm_init_structure.FTM_Ftmx == FTM0)
        LDR      R1,[SP, #+24]
        LDR.W    R2,??DataTable7  ;; 0x40038000
        CMP      R1,R2
...
//   63     SIM->SCGC6 |= SIM_SCGC6_FTM0_MASK;
        LDR.W    R1,??DataTable7_1  ;; 0x4004803c
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0x1000000
        LDR.W    R2,??DataTable7_1  ;; 0x4004803c
        STR      R1,[R2, #+0]
//   64   }
...
??LPLD_FTM_Init_0:
        LDR      R1,[SP, #+24]
        LDR.W    R2,??DataTable8_2  ;; 0x40039000
        CMP      R1,R2
...
??LPLD_FTM_Init_4:
        LDR      R1,[SP, #+24]
        LDR.W    R2,??DataTable8_3  ;; 0x400b8000
        CMP      R1,R2
        ...
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0x1000000
        LDR.W    R2,??DataTable8_4  ;; 0x40048030
        STR      R1,[R2, #+0]
        B.N      ??LPLD_FTM_Init_1
??LPLD_FTM_Init_5:
        LDR      R1,[SP, #+24]
        LDR.W    R2,??DataTable8_5  ;; 0x400b9000
        CMP      R1,R2
...
//  134   if(ftm_init_structure.FTM_Ftmx == FTM0)
        LDR      R0,[SP, #+16]
        LDR.W    R1,??DataTable7  ;; 0x40038000
        CMP      R0,R1
        BNE.N    ??LPLD_FTM_Deinit_0
//  135   {
//  136     SIM->SCGC6 &= ~SIM_SCGC6_FTM0_MASK;
        LDR.W    R0,??DataTable7_1  ;; 0x4004803c
        LDR      R0,[R0, #+0]
...
??LPLD_FTM_Deinit_0:
        LDR      R0,[SP, #+16]
        LDR.W    R1,??DataTable8_2  ;; 0x40039000
        CMP      R0,R1
...
??LPLD_FTM_Deinit_3:
        LDR      R0,[SP, #+16]
        LDR.W    R1,??DataTable8_3  ;; 0x400b8000
        CMP      R0,R1
...
??LPLD_FTM_Deinit_4:
        LDR      R0,[SP, #+16]
        LDR.W    R1,??DataTable8_5  ;; 0x400b9000
        CMP      R0,R1
        BNE.N    ??LPLD_FTM_Deinit_5
        LDR.W    R0,??DataTable8_4  ;; 0x40048030
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x2000000
        LDR.W    R1,??DataTable8_4  ;; 0x40048030
...
//  630   
//  631   if(ftmx == FTM0)
        LDR.N    R1,??DataTable7  ;; 0x40038000
        CMP      R0,R1
...
??LPLD_FTM_EnableIrq_4:
        LDR.W    R1,??DataTable8_5  ;; 0x400b9000
        CMP      R0,R1
        BNE.N    ??LPLD_FTM_EnableIrq_5
        MOVS     R0,#+3
        B.N      ??LPLD_FTM_EnableIrq_1
??LPLD_FTM_EnableIrq_5:
        MOVS     R0,#+0
...
??LPLD_FTM_DisableIrq_4:
        LDR.W    R1,??DataTable8_5  ;; 0x400b9000
        CMP      R0,R1
        BNE.N    ??LPLD_FTM_DisableIrq_5
        MOVS     R0,#+3
        B.N      ??LPLD_FTM_DisableIrq_1
??LPLD_FTM_DisableIrq_5:
        MOVS     R0,#+0
...
//  864   {
//  865     if(ftmx == FTM0)
        LDR.N    R2,??DataTable7  ;; 0x40038000
        CMP      R1,R2
...
//  890   if(ftmx == FTM0)
LPLD_FTM_PinInit:
        LDR.W    R3,??DataTable8_8  ;; 0x40038000
        CMP      R0,R3
...
//  896         PORTA->PCR[3] = PORTA->PCR[3] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable8_9  ;; 0x4004900c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable8_9  ;; 0x4004900c
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_10:
        ...
        LDR.W    R0,??DataTable8_10  ;; 0x4004b004
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable8_10  ;; 0x4004b004
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_3:
        ...
        LDR.W    R0,??DataTable8_11  ;; 0x40049010
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable8_11  ;; 0x40049010
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_16:
...
??LPLD_FTM_PinInit_15:
        ...
        LDR.W    R0,??DataTable8_12  ;; 0x4004b008
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable8_12  ;; 0x4004b008
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_2:
        ...
        LDR.W    R0,??DataTable8_13  ;; 0x40049014
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable8_13  ;; 0x40049014
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_19:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_18:
        ...
        LDR.W    R0,??DataTable8_14  ;; 0x4004b00c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable8_14  ;; 0x4004b00c
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_5:
        ...
        LDR.W    R0,??DataTable8_15  ;; 0x40049018
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable8_15  ;; 0x40049018
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_22:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_21:
        ...
        LDR.W    R0,??DataTable8_16  ;; 0x4004b010
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable8_16  ;; 0x4004b010
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_4:
        ...
        LDR.W    R0,??DataTable9  ;; 0x4004901c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable9  ;; 0x4004901c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_25:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_24:
        ...
        LDR.W    R0,??DataTable9_1  ;; 0x4004c010
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable9_1  ;; 0x4004c010
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_7:
        ...
        LDR.W    R0,??DataTable9_2  ;; 0x40049000
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable9_2  ;; 0x40049000
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_28:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_27:
        ...
        LDR.W    R0,??DataTable11  ;; 0x4004c014
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable11  ;; 0x4004c014
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_6:
        ...
        LDR.W    R0,??DataTable13  ;; 0x40049004
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13  ;; 0x40049004
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_31:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_30:
        ...
        LDR.W    R0,??DataTable13_1  ;; 0x4004c018
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_1  ;; 0x4004c018
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_8:
        ...
        LDR.W    R0,??DataTable13_2  ;; 0x40049008
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_2  ;; 0x40049008
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_34:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_33:
        ...
        LDR.W    R0,??DataTable13_3  ;; 0x4004c01c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_3  ;; 0x4004c01c
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_9:
        ...
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_0:
        LDR.W    R3,??DataTable8_2  ;; 0x40039000
        CMP      R0,R3
...
??LPLD_FTM_PinInit_37:
        ...
        LDR.W    R0,??DataTable13_4  ;; 0x40049020
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_4  ;; 0x40049020
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_43:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_42:
        ...
        LDR.W    R0,??DataTable13_5  ;; 0x40049030
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_5  ;; 0x40049030
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_44:
        ...
        LDR.W    R0,??DataTable13_6  ;; 0x4004a000
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_6  ;; 0x4004a000
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_43
??LPLD_FTM_PinInit_45:
        MOVS     R0,#+0
...
??LPLD_FTM_PinInit_38:
        ...
        LDR.W    R0,??DataTable13_7  ;; 0x40049024
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_7  ;; 0x40049024
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_47:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_46:
        ...
        LDR.W    R0,??DataTable13_8  ;; 0x40049034
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_8  ;; 0x40049034
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_48:
        ...
        LDR.W    R0,??DataTable13_9  ;; 0x4004a004
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_9  ;; 0x4004a004
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_47
??LPLD_FTM_PinInit_49:
        MOVS     R0,#+0
...
??LPLD_FTM_PinInit_56:
        ...
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_36:
        LDR.N    R3,??DataTable8_3  ;; 0x400b8000
        CMP      R0,R3
...
??LPLD_FTM_PinInit_58:
        ...
        LDR.W    R0,??DataTable13_10  ;; 0x40049028
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_10  ;; 0x40049028
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_64:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_63:
        ...
        LDR.W    R0,??DataTable13_11  ;; 0x4004a048
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_11  ;; 0x4004a048
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_59:
        ...
        LDR.W    R0,??DataTable13_12  ;; 0x4004902c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_12  ;; 0x4004902c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_67:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_66:
        ...
        LDR.W    R0,??DataTable13_13  ;; 0x4004a04c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_13  ;; 0x4004a04c
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinInit_62:
        ...
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_57:
        LDR.N    R3,??DataTable8_5  ;; 0x400b9000
        CMP      R0,R3
        BNE.W    ??LPLD_FTM_PinInit_75
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        CMP      R1,#+0
        BEQ.N    ??LPLD_FTM_PinInit_76
        CMP      R1,#+2
        BEQ.N    ??LPLD_FTM_PinInit_77
        BCC.N    ??LPLD_FTM_PinInit_78
        CMP      R1,#+4
        BEQ.W    ??LPLD_FTM_PinInit_79
        BCC.N    ??LPLD_FTM_PinInit_80
        CMP      R1,#+6
        BEQ.W    ??LPLD_FTM_PinInit_81
        BCC.W    ??LPLD_FTM_PinInit_82
        CMP      R1,#+7
        BEQ.W    ??LPLD_FTM_PinInit_83
        B.N      ??LPLD_FTM_PinInit_84
??LPLD_FTM_PinInit_76:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+129
        BNE.N    ??LPLD_FTM_PinInit_85
        LDR.W    R0,??DataTable13_14  ;; 0x4004d014
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_14  ;; 0x4004d014
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_86:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_85:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+92
        BNE.N    ??LPLD_FTM_PinInit_87
        LDR.W    R0,??DataTable13_15  ;; 0x4004c000
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_15  ;; 0x4004c000
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_86
??LPLD_FTM_PinInit_87:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_78:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+130
        BNE.N    ??LPLD_FTM_PinInit_88
        LDR.W    R0,??DataTable13_16  ;; 0x4004d018
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_16  ;; 0x4004d018
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_89:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_88:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+92
        BNE.N    ??LPLD_FTM_PinInit_90
        LDR.W    R0,??DataTable13_17  ;; 0x4004c004
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_17  ;; 0x4004c004
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_89
??LPLD_FTM_PinInit_90:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_77:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+131
        BNE.N    ??LPLD_FTM_PinInit_91
        LDR.W    R0,??DataTable13_18  ;; 0x4004d01c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_18  ;; 0x4004d01c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_92:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_91:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+92
        BNE.N    ??LPLD_FTM_PinInit_93
        LDR.W    R0,??DataTable13_19  ;; 0x4004c008
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_19  ;; 0x4004c008
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_92
??LPLD_FTM_PinInit_93:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_80:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+132
        BNE.N    ??LPLD_FTM_PinInit_94
        LDR.W    R0,??DataTable13_20  ;; 0x4004d020
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_20  ;; 0x4004d020
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_95:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_94:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+92
        BNE.N    ??LPLD_FTM_PinInit_96
        LDR.W    R0,??DataTable13_21  ;; 0x4004c00c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable13_21  ;; 0x4004c00c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_95
??LPLD_FTM_PinInit_96:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_79:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+133
        BNE.N    ??LPLD_FTM_PinInit_97
        LDR.W    R0,??DataTable13_22  ;; 0x4004d024
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_22  ;; 0x4004d024
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_98:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_97:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+68
        BNE.N    ??LPLD_FTM_PinInit_99
        LDR.W    R0,??DataTable13_23  ;; 0x4004b020
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_23  ;; 0x4004b020
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_98
??LPLD_FTM_PinInit_99:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_82:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+134
        BNE.N    ??LPLD_FTM_PinInit_100
        LDR.W    R0,??DataTable13_24  ;; 0x4004d028
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_24  ;; 0x4004d028
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_101:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_100:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+69
        BNE.N    ??LPLD_FTM_PinInit_102
        LDR.W    R0,??DataTable13_25  ;; 0x4004b024
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_25  ;; 0x4004b024
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_101
??LPLD_FTM_PinInit_102:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_81:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+135
        BNE.N    ??LPLD_FTM_PinInit_103
        LDR.W    R0,??DataTable13_26  ;; 0x4004d02c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_26  ;; 0x4004d02c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_104:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_103:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+70
        BNE.N    ??LPLD_FTM_PinInit_105
        LDR.W    R0,??DataTable13_27  ;; 0x4004b028
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_27  ;; 0x4004b028
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_104
??LPLD_FTM_PinInit_105:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_83:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+136
        BNE.N    ??LPLD_FTM_PinInit_106
        LDR.W    R0,??DataTable13_28  ;; 0x4004d030
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x600
        LDR.W    R1,??DataTable13_28  ;; 0x4004d030
        STR      R0,[R1, #+0]
??LPLD_FTM_PinInit_107:
        B.N      ??LPLD_FTM_PinInit_12
??LPLD_FTM_PinInit_106:
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        CMP      R2,#+71
        BNE.N    ??LPLD_FTM_PinInit_108
        LDR.W    R0,??DataTable13_29  ;; 0x4004b02c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R1,??DataTable13_29  ;; 0x4004b02c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_FTM_PinInit_107
??LPLD_FTM_PinInit_108:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinInit_13
??LPLD_FTM_PinInit_84:
        MOVS     R0,#+0
...
// 1138   if(ftmx == FTM0)
LPLD_FTM_PinDeinit:
        LDR.W    R2,??DataTable13_30  ;; 0x40038000
        CMP      R0,R2
...
??LPLD_FTM_PinDeinit_1:
        LDR.W    R0,??DataTable13_31  ;; 0x4004900c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
...
// 1146         PORTC->PCR[1] = PORT_PCR_MUX(0);
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_32  ;; 0x4004b004
        STR      R0,[R1, #+0]
// 1147       break;
// 1148     case FTM_Ch1:
...
??LPLD_FTM_PinDeinit_3:
        LDR.W    R0,??DataTable13_33  ;; 0x40049010
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_14
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_33  ;; 0x40049010
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_14:
        LDR.W    R0,??DataTable13_34  ;; 0x4004b008
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_15
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_34  ;; 0x4004b008
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_15:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_2:
        LDR.W    R0,??DataTable13_35  ;; 0x40049014
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_16
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_35  ;; 0x40049014
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_16:
        LDR.W    R0,??DataTable13_36  ;; 0x4004b00c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_17
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_36  ;; 0x4004b00c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_17:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_5:
        LDR.W    R0,??DataTable13_37  ;; 0x40049018
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_18
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_37  ;; 0x40049018
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_18:
        LDR.W    R0,??DataTable13_38  ;; 0x4004b010
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_19
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13_38  ;; 0x4004b010
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinDeinit_0:
        LDR.W    R2,??DataTable13_39  ;; 0x40039000
        CMP      R0,R2
...
??LPLD_FTM_PinDeinit_43:
        ...
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_8  ;; 0x40049034
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_44:
        LDR.N    R0,??DataTable13_9  ;; 0x4004a004
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_45
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_9  ;; 0x4004a004
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinDeinit_28:
        LDR.W    R2,??DataTable13_40  ;; 0x400b8000
        CMP      R0,R2
...
??LPLD_FTM_PinDeinit_47:
        LDR.N    R0,??DataTable13_10  ;; 0x40049028
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_52
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_10  ;; 0x40049028
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_52:
        LDR.N    R0,??DataTable13_11  ;; 0x4004a048
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_53
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_11  ;; 0x4004a048
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_53:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_48:
        LDR.N    R0,??DataTable13_12  ;; 0x4004902c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_54
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_12  ;; 0x4004902c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_54:
        LDR.N    R0,??DataTable13_13  ;; 0x4004a04c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_55
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_13  ;; 0x4004a04c
        STR      R0,[R1, #+0]
...
??LPLD_FTM_PinDeinit_46:
        LDR.N    R2,??DataTable13_41  ;; 0x400b9000
        CMP      R0,R2
        BNE.W    ??LPLD_FTM_PinDeinit_60
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        CMP      R1,#+0
        BEQ.N    ??LPLD_FTM_PinDeinit_61
        CMP      R1,#+2
        BEQ.N    ??LPLD_FTM_PinDeinit_62
        BCC.N    ??LPLD_FTM_PinDeinit_63
        CMP      R1,#+4
        BEQ.N    ??LPLD_FTM_PinDeinit_64
        BCC.N    ??LPLD_FTM_PinDeinit_65
        CMP      R1,#+6
        BEQ.W    ??LPLD_FTM_PinDeinit_66
        BCC.N    ??LPLD_FTM_PinDeinit_67
        CMP      R1,#+7
        BEQ.W    ??LPLD_FTM_PinDeinit_68
        B.N      ??LPLD_FTM_PinDeinit_69
??LPLD_FTM_PinDeinit_61:
        LDR.N    R0,??DataTable13_14  ;; 0x4004d014
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_70
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_14  ;; 0x4004d014
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_70:
        LDR.N    R0,??DataTable13_15  ;; 0x4004c000
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_71
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_15  ;; 0x4004c000
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_71:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_63:
        LDR.N    R0,??DataTable13_16  ;; 0x4004d018
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_72
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_16  ;; 0x4004d018
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_72:
        LDR.N    R0,??DataTable13_17  ;; 0x4004c004
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_73
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_17  ;; 0x4004c004
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_73:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_62:
        LDR.N    R0,??DataTable13_18  ;; 0x4004d01c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_74
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_18  ;; 0x4004d01c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_74:
        LDR.N    R0,??DataTable13_19  ;; 0x4004c008
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_75
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_19  ;; 0x4004c008
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_75:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_65:
        LDR.N    R0,??DataTable13_20  ;; 0x4004d020
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_76
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_20  ;; 0x4004d020
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_76:
        LDR.N    R0,??DataTable13_21  ;; 0x4004c00c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1024
        BNE.N    ??LPLD_FTM_PinDeinit_77
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_21  ;; 0x4004c00c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_77:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_64:
        LDR.N    R0,??DataTable13_22  ;; 0x4004d024
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_78
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_22  ;; 0x4004d024
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_78:
        LDR.N    R0,??DataTable13_23  ;; 0x4004b020
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_79
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_23  ;; 0x4004b020
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_79:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_67:
        LDR.N    R0,??DataTable13_24  ;; 0x4004d028
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_80
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_24  ;; 0x4004d028
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_80:
        LDR.N    R0,??DataTable13_25  ;; 0x4004b024
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_81
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_25  ;; 0x4004b024
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_81:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_66:
        LDR.N    R0,??DataTable13_26  ;; 0x4004d02c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_82
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_26  ;; 0x4004d02c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_82:
        LDR.N    R0,??DataTable13_27  ;; 0x4004b028
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_83
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_27  ;; 0x4004b028
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_83:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_68:
        LDR.N    R0,??DataTable13_28  ;; 0x4004d030
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+1536
        BNE.N    ??LPLD_FTM_PinDeinit_84
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_28  ;; 0x4004d030
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_84:
        LDR.N    R0,??DataTable13_29  ;; 0x4004b02c
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x700
        CMP      R0,#+768
        BNE.N    ??LPLD_FTM_PinDeinit_85
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_29  ;; 0x4004b02c
        STR      R0,[R1, #+0]
??LPLD_FTM_PinDeinit_85:
        B.N      ??LPLD_FTM_PinDeinit_12
??LPLD_FTM_PinDeinit_69:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinDeinit_13
??LPLD_FTM_PinDeinit_60:
        MOVS     R0,#+0
        B.N      ??LPLD_FTM_PinDeinit_13
// 1329 }
