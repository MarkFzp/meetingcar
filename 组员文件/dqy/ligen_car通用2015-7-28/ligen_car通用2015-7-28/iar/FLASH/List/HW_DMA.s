...
//    Endian       =  little
//    Source file  =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_DMA.c
//    Command line =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\lib\LPLD\HW\HW_DMA.c
...
//    List file    =  
//        C:\Users\Administrator\Desktop\lpld\LPLD_OSKinetis_V3.1\project\ligen_car通用7-23-20.36\iar\FLASH\List\HW_DMA.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  600   if( DMA0->INT & 0x1u<<0)
        LDR.W    R0,??DataTable18_8  ;; 0x40008024
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  605     DMA0->INT |= 0x1u<<0;
        ...
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.W    R1,??DataTable18_8  ;; 0x40008024
        STR      R0,[R1, #+0]
